		...
		<div class="sixteen columns">
			...
			<hr/>
				...
				<h3>Boven</h3>
						...
						<legend>Schemerlamp Skamer</legend>
						  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
				         		<button class="button" type="submit" name="button" value="13 1" />aan</button>
				         		<button class="button" type="submit" name="button" value="13 0" />uit</button>
						  </form>


						<legend>Extender</legend>
						  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
